...
interface CourseProgressCardProps {
  courseProgress: { id: number; name: string; completed: boolean }[];
}

export default function CourseProgressCard({ courseProgress }: CourseProgressCardProps) {
    ...
    <Card className="h-full">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {courseProgress.map((course: { id: number; name: string; completed: boolean }, index: number) => (
            <motion.div
