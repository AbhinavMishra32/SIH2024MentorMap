...
export default function EnhancedAIChat() {
  ...
  return (
    // <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-yellow-100 to-white p-4">
    //   <motion.div
    //     initial={{ scale: 0.9, opacity: 0 }}
    //     animate={{ scale: 1, opacity: 1 }}
    //     transition={{ duration: 0.5 }}
    //   >
    <Card className="w-full max-w-md h-[600px] flex flex-col shadow-2xl overflow-hidden bg-white border-yellow-300 border-2 rounded-3xl">
      ...
      <CardContent className="flex-1 overflow-y-auto p-6 space-y-4 bg-gradient-to-b from-yellow-50 to-white">
        <AnimatePresence>
      ...
      <CardFooter className="p-4 bg-white border-t border-yellow-100">
