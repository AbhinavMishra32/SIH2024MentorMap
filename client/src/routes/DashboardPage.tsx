...
export default function Dashboard() {
  ...
  const [completedLessonsUnderCourse, setCompletedLessonsUnderCourse] = useState<{ categoryTitle: string, fullMark: number }[]>([]);
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        setCompletedLessonsUnderCourse(response.data.completedLessonsUnderCourse);
      } catch (error) {
